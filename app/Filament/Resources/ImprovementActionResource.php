...
class ImprovementActionResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'improvement_action_completions.view' => \App\Filament\Resources\ImprovementActionCompletionResource\Pages\ViewImprovementActionCompletion::route('/{improvementactionId}/completion/{completionId}/view'),
